...
class Model
{
    ...
    {
        $images = ipDb()->selectAll('Social', array('title', 'target', 'url', 'imageFile'), 'ORDER BY imageOrder ASC');
        return $images;
    }
    ...
    public static function saveImageRecord($image)
    {
        ...
        $imageId = ipDb()->insert('Social', $image);
        ipBindFile($image['imageFile'], 'Table_Social_image', $imageId);
